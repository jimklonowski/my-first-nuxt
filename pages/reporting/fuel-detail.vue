...
export default {
  ...
  data: () => ({
    ...
    headers: [
      ...
      { text: 'Except', key: 'reports.fuel_detail.except', align: 'start', width: '100', value: 'except' },
  ...
  methods: {
    async getReportData () {
      this.loading = true
      const url = 'https://api.emkay.com/rest-test/fuel-detail'
